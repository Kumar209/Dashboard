...
const StudentPerformance = () => {
  ...
  return (
    <div className="mt-[2rem] mb-6 lg:mb-0 lg:w-[420px] lg:h-[400px] ml-3 lg:ml-7 rounded-[15px] shadow-3xl">
      <div className="pl-4 mb-1 pt-3 font-semibold">
        <span>Student's Perfomance</span>
      </div>

      <div className="flex flex-col lg:flex-row pl-4 pt-2 gap-4 px-5">
